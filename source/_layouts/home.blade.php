...
<html lang="en">
    ...
    <body class="antialiased font-sans">
        ...
        <section class="hero text-white bg-gray-800 bg-center bg-cover xl:bg-fixed">  
            ...
            <div class="container mx-auto">
                <div class="flex px-5 pt-40 pb-24 md:flex-row flex-col items-center z-50">
                    <div class="lg:flex-grow md:pr-16 flex flex-col md:items-start md:text-left md:ml-6 mb-16 md:mb-0 items-center text-center">
                        <h1 class="text-3xl md:text-4xl lg:text-5xl uppercase font-semibold leading-none tracking-tight mb-4 font-medium text-white">
                            <span class="text-red-500 lg:text-2xl inline-block leading-loose">Welcome to the</span>
